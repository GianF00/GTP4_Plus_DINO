...
from functions import drawing_boxes, calculate_predi_time, calculate_iou,get_single_image_results, help_iou_more_coordinates
...
#image_path = "gt_bordny9_ny1.jpg"
#image_path = "gt_bordny8_ny.jpg"
#image_path = "gt_ordning11.jpg"
#image_path = "gt_ordning14.jpg"
image_path = "gt_ordning15.jpg"
...
value_of_bThresh = input_data1["box_threshold"]
str_bThresh = f"DINO's box threshold {value_of_bThresh}"
value = 37
PredimgToBeStored = f"GPT4_pred6_bordny15_bt{value}.jpg"
BlueimgToBeStored = f"GPT4_blue6_bordny15_bt{value}.jpg"
...
plt.title('Confidence levels of different objects generated by GPT4 - Vision + Grounding DINO')
...
plot_path = fr"C:\Users\gianf\OneDrive\Skrivbord\YOLOv8\GPT4_confidence6_bar_chart{value}.png"
...
mydata = [
    ...
    ["recall", f"{recall}"],
    ["coordinates", f"{gt}"],
    ["DINO predicted coordinates of objects: ", f"{pr_boxes}"],
